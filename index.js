...
const LIFECYCLE_MENU_SECTIONS = {
  ...
  lifecycle: [
    ...
    ["lifecycle.capital.perPositionSol", "Per-position SOL"],
    ["lifecycle.capital.minSolReserve", "Min SOL reserve"],
    ["lifecycle.capital.txFeeBufferSol", "Tx fee buffer SOL"],
    ["lifecycle.capital.newPositionOverheadSol", "New pos overhead SOL"],
    ...
    ["lifecycle.reshape.walletSettleMs", "Reshape settle ms"],
    ["lifecycle.reshape.depositSafetyBps", "Reshape safety bps"],
  ...
  entry: [
    ...
    ["lifecycle.entry.lpSlippagePct", "LP slippage %"],
